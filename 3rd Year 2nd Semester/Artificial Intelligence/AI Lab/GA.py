...
def genetic_algorithm():
    ...
    generation = 0
    best_solution = None
    best_fitness = FITNESS_THRESHOLD  # Set initial fitness to the threshold
    ...
    while generation < GENERATIONS:
        ...
        if best_fitness == FITNESS_THRESHOLD:
            print("Targeted fitness found! Exiting the algorithm.")
            break

    if best_fitness != 0:
        print("Targeted fitness not found within the specified number of generations.")
